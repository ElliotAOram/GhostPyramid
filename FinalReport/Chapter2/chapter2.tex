...
\begin{figure}[h!]
	\centering{
		...
		\caption{The website design for the Charades game. The diagram shows the Template structure of the website as well as when pages are updated and when polling of the API takes place.}
		\label{fig:website_design}
	}
\end{figure}

Figure \ref{fig:website_design}...
